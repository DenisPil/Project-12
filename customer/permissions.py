...
class IsSalesContact(BasePermission):
    ...
    """Les permissions de l'équipe de vente pour les clients"""
...
class IsManagementTeam(BasePermission):
    ...
    """Les permissions de l'équipe de management pour les clients"""
...
class IsSupportTeam(BasePermission):
    ...
    """Les permissions de l'équipe support pour les clients"""
